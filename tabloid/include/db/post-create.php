...
/*
	Database functions for creating a question, answer or comment
*/
...
function qa_db_post_create($type, $parentid, $userid, $cookieid, $ip, $title, $content, $format, $tagstring, $notify, $categoryid = null, $name = null, $image = null, $lead = null)
{
	qa_db_query_sub(
		'INSERT INTO ^posts (categoryid, type, parentid, userid, cookieid, createip, title, content, format, tags, notify, name, created, image, `lead`) ' .
		'VALUES (#, $, #, $, #, UNHEX($), $, $, $, $, $, $, NOW(), $, $)',
		$categoryid, $type, $parentid, $userid, $cookieid, bin2hex(@inet_pton($ip)), $title, $content, $format, $tagstring, $notify, $name, $image, $lead
	);
...
{
	qa_db_ifcategory_qcount_update($path['categoryid']); // requiresCATEGORY_DEPTH=4
