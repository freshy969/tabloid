...
/*
	Controller for page listing recent questions without upvoted/selected/any answers
*/
...
// Get list of unanswered questions, allow per-category ifALLOW_UNINDEXED_QUERIES set in qa-config.php

if (ALLOW_UNINDEXED_QUERIES)
...
list($questions, $categories, $categoryid) = qa_db_select_with_pending(
	...
	ALLOW_UNINDEXED_QUERIES ? qa_db_category_nav_selectspec($categoryslugs, false, false, true) : null,
...
$qa_content = qa_q_list_page_content(
	...
	ALLOW_UNINDEXED_QUERIES ? $categories : array(), // categories for navigation (null if not shown on this page)
	ALLOW_UNINDEXED_QUERIES ? $categoryid : null, // selected category id (null if not relevant)
	false, // show question counts in category navigation
	ALLOW_UNINDEXED_QUERIES ? 'unanswered/' : null, // prefix for links in category navigation (null if no navigation)
