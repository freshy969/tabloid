...
/*
	Controller for page listing user's favorites
*/
...
list($numQs, $questions, $numUsers, $users, $numTags, $tags, $categories) = qa_db_select_with_pending(
	...
	FINAL_EXTERNAL_USERS ? null : qa_db_selectspec_count(qa_db_user_favorite_users_selectspec($userid)),
	FINAL_EXTERNAL_USERS ? null : qa_db_user_favorite_users_selectspec($userid, $pagesize_users),
...
$usershtml = qa_userids_handles_html(FINAL_EXTERNAL_USERS ? $questions : array_merge($questions, $users));
