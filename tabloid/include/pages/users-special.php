...
/*
	Controller for admin page showing users with non-standard privileges
*/
...
$users = qa_db_select_with_pending(qa_db_users_from_level_selectspec(USER_LEVEL_EXPERT));
