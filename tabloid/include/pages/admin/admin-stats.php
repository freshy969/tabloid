...
$qa_content['form'] = array(
	...
	'fields' => array(
		'q2a_version' => array(
			...
			'value' => qa_html(TABLOID_VERSION),
		),

		'q2a_date' => array(
			'label' => qa_lang_html('admin/q2a_build_date'),
			'value' => qa_html(BUILD_DATE),
		),
		...
		'users' => array(
			...
			'value' => FINAL_EXTERNAL_USERS ? '' : qa_html(qa_format_number(qa_db_count_users())),
		),
...
$qa_content['script_onloads'][] = array(
	"version_check('https://raw.githubusercontent.com/gotzmann/tabloid/master/VERSION.txt', " . qa_js(qa_html(VERSION), true) . ", 'tabloid-version', true);"
);
*/
