...
$blockable = qa_user_level_maximum() >= USER_LEVEL_MODERATOR; // allow moderator in one category to block across all categories
	...
	elseif ($blockable) {
		...
		if (qa_clicked('dohideall') && !qa_user_maximum_permit_error('permit_hide_show')) {
			...
			foreach ($postids as $postid)
				qa_post_set_status($postid, POST_STATUS_HIDDEN, $userid);
