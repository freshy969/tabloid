...
/*
	Server-side response to Ajax request based on ask a question title
*/
...
if ($doaskcheck || $doexampletags) {
	$countqs = max($doexampletags ? DB_RETRIEVE_ASK_TAG_QS : 0, $doaskcheck ? qa_opt('page_size_ask_check_qs') : 0);
