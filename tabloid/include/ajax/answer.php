...
/*
	Server-side response to Ajax create answer requests
*/
...
if (@$question['basetype'] == 'Q' && !qa_post_is_closed($question) && !qa_user_post_permit_error('permit_post_a', $question,LIMIT_ANSWERS)) {
