...
/*
	Widget module class for related questions
*/
...
class related_qs
{
	...
	public function output_widget($region, $place, $themeobject, $template, $request, $qa_content)
	{
		...
		if (!isset($qa_content['q_view']['raw']['type']) || ($qa_content['q_view']['raw']['type'] != 'Q' && $qa_content['q_view']['raw']['type'] != 'POST')) // question might not be visible, etc...
			return;
