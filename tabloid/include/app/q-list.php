...
/*
	Controller for most question listing pages, plus custom pages and plugin pages
*/
	...
	$pagelinkparams = null, $categoryparams = null, $dummy = null)
{
	...
	if (isset($userid) && isset($categoryid)) {
		...
		$qa_content['favorite'] = qa_favorite_form(ENTITY_CATEGORY, $categoryid, $categoryisfavorite,
