...
/*
	Handles favoriting and unfavoriting (application level)
*/
 ...
 * @param string $entitytype Entity type code (one of ENTITY_* constants)
...
{
	require_once INCLUDE_DIR . 'db/favorites.php';
	...
	if ($entitytype == ENTITY_USER && $userid == $entityid) {
		return;
	}
