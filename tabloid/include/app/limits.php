...
/*
	Monitoring and rate-limiting user actions (application level)
*/


define('LIMIT_QUESTIONS', 'Q');
define('LIMIT_ANSWERS', 'A');
define('LIMIT_COMMENTS', 'C');
define('LIMIT_VOTES', 'V');
define('LIMIT_REGISTRATIONS', 'R');
define('LIMIT_LOGINS', 'L');
define('LIMIT_UPLOADS', 'U');
define('LIMIT_FLAGS', 'F');
define('LIMIT_MESSAGES', 'M'); // i.e. private messages
define('LIMIT_WALL_POSTS', 'W');


/**
 * How many more times the logged in user (and requesting IP address) can perform an action this hour.
 * @param string $action One of theLIMIT_* constants defined above.
 * @return int
 */
...
/**
 * Return how many more times user $userid and/or the requesting IP can perform $action (aLIMIT_* constant) this hour.
...
function qa_limits_remaining($userid, $action)
{
	...
	require_once INCLUDE_DIR . 'db/limits.php';
