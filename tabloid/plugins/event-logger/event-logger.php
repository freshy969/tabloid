...
/*
	Event module class for event logger plugin
*/
...
class event_logger
{
		...
		if (qa_opt('event_logger_to_database')) {
			...
			if (!in_array($tablename, $table_list)) {
				...
				return 'CREATE TABLE ^eventlog (' .
					...
					'handle VARCHAR(' . DB_MAX_HANDLE_LENGTH . '),' .
	...
	public function admin_form(&$qa_content)
	{
		...
		return array(
			...
			'fields' => array(
				array(
					'label' => 'Log events to <code>' . TABLE_PREFIX . 'eventlog</code> database table',
...
// 						$string = "Tabloid " .VERSION . " log file generated by Event Logger plugin.\n" .
